...
MAINSRC=create.cpp use.cpp benchmark.cpp exp-query.cpp benchmark2.cpp #use.cpp getsize.cpp
...
EXECUTABLE=create use benchmark exp-query benchmark2 #getsize text2adjacencybin
